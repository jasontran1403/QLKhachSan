...
public class TaiKhoanDAO {
        ...
        public List<TaiKhoan> SelectNVChuaCoTK() {
        ...
        public List<TaiKhoan> SelectByKeyWord(String keyword) {
                String sql = "select * from NhanVien where (MaNhanVien like ?  or TenNhanVien like ?) and  MaNhanVien not in (select MaNhanVien from TaiKhoan)";
                String ans = "%" + keyword + "%";
